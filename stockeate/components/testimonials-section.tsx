...
function Badge({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="px-[14px] py-[6px] bg-white shadow-[0px_0px_0px_4px_rgba(30,64,175,0.05)] overflow-hidden rounded-[90px] flex justify-start items-center gap-[8px] border border-[#E5E7EB] shadow-xs">
...
export default function TestimonialsSection() {
  ...
  return (
    <div className="w-full border-b border-[#E5E7EB] flex flex-col justify-center items-center bg-[#F8FAFC]">
      {/* Header Section */}
        ...
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            ...
            <div className="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-[#0F172A] text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] font-sans h-[200px] md:h-[210px] overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
              ...
              >
                <div className="self-stretch justify-center flex flex-col text-[#0F172A] text-lg font-medium leading-[26px] font-sans">
                  {testimonials[activeTestimonial].name}
                </div>
                <div className="self-stretch justify-center flex flex-col text-[#475569] text-lg font-medium leading-[26px] font-sans">
          ...
          <div className="pr-6 justify-start items-start gap-[14px] flex">
            <button
              ...
              className="w-9 h-9 shadow-[0px_1px_2px_rgba(0,0,0,0.08)] overflow-hidden rounded-full border border-[#E5E7EB] justify-center items-center gap-2 flex hover:bg-[#EFF6FF] transition-colors"
            >
